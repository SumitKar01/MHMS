...
public class Reports extends JFrame implements ActionListener{
    ...
    JLabel searchLabel = new JLabel("All Records");
    
    
    
    int n = 0;
    Reports( Person getpat){
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource()==backButton){
            ...
            PatientDashboard test = new PatientDashboard(pat); 
    ...
    public int counter() throws FileNotFoundException{
        ...
        login = new File(pat.getNID()+"Report.txt");
       int x =0;
    ...
    public void LoadTable(){
        ...
        try {
            ...
            model.addColumn("Symptomps");
            model.addColumn("Tests");
            model.addColumn("Diagnosed for Days");
            model.addColumn("Doctors name");
            model.addColumn("Doctors number");
            
            Scanner input = new Scanner(new File(pat.getNID()+"Report.txt"));
